...
This module provides shared functionality for loading custom assets (bodies, CAS, rigs, etc.)
"""
...
class BaseCustomLoader(Operator):
    ...
    # Subclasses can override this to filter specific object types
    exclude_object_types = set()  # e.g., {'CAMERA', 'LIGHT'}
        ...
        try:
            ...
            if data_to.collections:
                ...
                for obj in data_to.objects:
                    if obj is not None and obj.type not in self.exclude_object_types:
                        ...
                        if obj_base_name.startswith(constants.S4STUDIO_MESH_PREFIX) and obj.type == 'MESH':
                            obj.select_set(True)
                            loaded_objects.append(obj)

                        # Check for armatures separately
